        ...
        <div className={`container ${styles.headerContainer}`}>
            ...
            <div className={`group ${styles.menu}`}>
                ...
                <ul className={styles.drop}>
                  <li className={styles.dropli}>Сервис распознования</li>
                  <li className={styles.dropli}>История распознования</li>
                  <li className={styles.dropli}>Настройки профиля</li>
